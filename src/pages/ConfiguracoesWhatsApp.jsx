  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 fade-in min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-800 dark:text-zinc-200">
      ...
      <div className="mt-6 max-w-7xl space-y-6">
        ...
        {/* ── Linha 1: Status + Conexão lado a lado no desktop ── */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="flex items-start gap-3 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-850">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                  Quando ativo, o sistema gera e agenda lembretes para clientes antes dos horários agendados.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mb-4 leading-relaxed">
              Selecione quais lembretes devem ser enviados. Cada opção é independente.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <label className="flex items-center gap-3 p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-950/50 cursor-pointer transition-colors">
                <input
                  type="checkbox"
                  checked={form.lembrete_24h === 1}
                  onChange={(e) => setForm({ ...form, lembrete_24h: e.target.checked ? 1 : 0 })}
                  className="w-4 h-4 text-emerald-600 border-zinc-300 dark:border-zinc-750 rounded focus:ring-emerald-500 cursor-pointer shrink-0"
                />
                <div className="text-left">
                  <span className="text-sm font-semibold block text-zinc-900 dark:text-zinc-100">24h antes</span>
                  <span className="text-xs text-zinc-500 dark:text-zinc-400">Um dia antes</span>
                </div>
              </label>
              <label className="flex items-center gap-3 p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-950/50 cursor-pointer transition-colors">
                <input
                ...
                />
                <div className="text-left">
                  <span className="text-sm font-semibold block text-zinc-900 dark:text-zinc-100">2h antes</span>
                  <span className="text-xs text-zinc-500 dark:text-zinc-400">Duas horas antes</span>
                </div>
              </label>
              <label className="flex items-center gap-3 p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-950/50 cursor-pointer transition-colors">
                <input
                ...
                />
                <div className="text-left">
                  <span className="text-sm font-semibold block text-zinc-900 dark:text-zinc-100">1h antes</span>
                  <span className="text-xs text-zinc-500 dark:text-zinc-400">Uma hora antes</span>
                </div>
              </label>
            </div>
          </Card>
        ...
        {/* ── Conexão do WhatsApp (largura total) ── */}
        <Card className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm">
          <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-2 mb-4">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-5 leading-relaxed">
            Escolha como deseja enviar as mensagens de WhatsApp. Simule gratuitamente ou conecte um gateway profissional externo.
          </p>
          <div className="space-y-5">
              ...
              <div className="p-5 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-850">
                ...
                {localStatus.status === 'ready' ? (
                  <div className="space-y-4">
                    ...
                    <Button type="button" variant="destructive" size="sm" onClick={handleLocalDisconnect} className="w-full sm:w-auto">
                      Desconectar Celular
                    </Button>
                  </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl">
                      {localStatus.qr ? (
                        <div className="space-y-3 flex flex-col items-center">
                          <img src={localStatus.qr} alt="WhatsApp QR Code" className="w-52 h-52 p-2 bg-white rounded-lg shadow-sm border border-zinc-100" />
            ...
            {connectionMode === 'external' && (
              <div className="flex flex-col items-center justify-center space-y-4 p-8 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-850">
                <h4 className="text-sm font-bold text-zinc-950 dark:text-zinc-150">Integração com Provedor Externo</h4>
        ...
        {/* ── Template Lembrete: 2 colunas no desktop ── */}
        <Card className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  className="min-h-[200px] font-mono text-sm bg-zinc-50 border-zinc-200 dark:bg-zinc-950 dark:border-zinc-850 focus:bg-white"
                />
              </div>
                ...
                <div className="divide-y divide-zinc-200 dark:divide-zinc-800 text-xs">
                  {[
                    ...
                    <div key={v} className="grid grid-cols-3 p-2.5">
                      ...
                      <span className="col-span-2 text-zinc-650 dark:text-zinc-400">{d}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="space-y-2 lg:sticky lg:top-6 lg:self-start">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-semibold text-zinc-600 dark:text-zinc-400">Prévia do Lembrete</span>
              </div>
              <div className="rounded-2xl bg-[#E5DDD5] dark:bg-zinc-950 p-4 border border-zinc-200 dark:border-zinc-850 relative overflow-hidden min-h-[200px]">
                ...
                <div className="relative self-start bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 p-3.5 rounded-2xl rounded-tl-none shadow-sm max-w-[85%] text-sm whitespace-pre-wrap leading-relaxed">
                  {mockMessage()}
                  <div className="text-[10px] text-zinc-450 text-right mt-1.5">14:35 ✓✓</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            {form.agradecimento_ativo === 1 && (
              <div className="space-y-5">
                ...
                {/* Template + Prévia: 2 colunas no desktop */}
                <div className="flex items-center justify-between">
                  <span className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">Texto da mensagem de agradecimento</span>
                  <Button
                    variant="outline"
                    size="xs"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                    ...
                    <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden bg-zinc-50/50 dark:bg-zinc-950/20">
                      ...
                      <div className="divide-y divide-zinc-200 dark:divide-zinc-800 text-xs">
                        {[
                          ...
                          ['{servico}', 'Serviço(s) — nomes separados por vírgula'],
                          ['{profissional}', 'Profissional responsável'],
                        ].map(([v, d]) => (
                          <div key={v} className="grid grid-cols-3 p-2.5">
                            <span className="font-mono text-rose-600 dark:text-rose-400 font-semibold">{v}</span>
                            <span className="col-span-2 text-zinc-650 dark:text-zinc-400">{d}</span>
                          </div>
                        ))}
                  ...
                  <div className="space-y-2 lg:sticky lg:top-6 lg:self-start">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs font-semibold text-zinc-600 dark:text-zinc-400">Prévia — {form.agradecimento_tempo_minutos || 30} min após a conclusão</span>
                    </div>
                    <div className="rounded-2xl bg-[#E5DDD5] dark:bg-zinc-950 p-4 border border-zinc-200 dark:border-zinc-850 relative overflow-hidden min-h-[200px]">
                      <div className="absolute inset-0 opacity-5 pointer-events-none" style={{ backgroundImage: "radial-gradient(#000 10%, transparent 10%)", backgroundSize: "20px 20px" }} />
                      <div className="relative self-start bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 p-3.5 rounded-2xl rounded-tl-none shadow-sm max-w-[85%] text-sm whitespace-pre-wrap leading-relaxed">
                        {mockMessageAgradecimento()}
                        <div className="text-[10px] text-zinc-450 text-right mt-1.5">15:05 ✓✓</div>
                      </div>
                    </div>
                  </div>
                </div>
