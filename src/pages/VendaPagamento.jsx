    ...
    <div className="p-6 lg:p-8 fade-in max-w-4xl">
      ...
      <div className="bg-white border border-zinc-200 rounded-xl p-6 mb-6">
            ...
            <div key={i} className="grid grid-cols-12 gap-2 items-end">
              ...
              <div className="col-span-4">
                ...
                <Select value={p.forma_pagamento} onValueChange={(val) => updateLine(i, "forma_pagamento", val)}>
                  <SelectTrigger data-testid={`vpay-forma-${i}`}><SelectValue /></SelectTrigger>
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <Button data-testid="vpay-finish" onClick={executePayment} className="bg-[#84A59D] hover:bg-[#6F9189]"><CheckCircle2 className="w-4 h-4 mr-1" /> Registrar e Finalizar</Button>
        </div>
      </div>

      <div className="bg-white border border-zinc-200 rounded-xl overflow-x-auto mt-6">
