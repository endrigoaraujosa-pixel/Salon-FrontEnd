  ...
  return (
    <div className="p-3 sm:p-6 lg:p-8 fade-in max-w-5xl mx-auto w-full">
      ...
      <Dialog open={detailModalOpen} onOpenChange={setDetailModalOpen}>
        <DialogContent className="dialog-content sm:max-w-xl md:max-w-2xl lg:max-w-3xl rounded-2xl p-6 overflow-y-auto max-h-[90vh]" aria-describedby="dialog-historico-detalhe">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start justify-between bg-[#F8FBFB] dark:bg-[#1a2322] p-4 rounded-xl border border-[#E8EFEF] dark:border-[#2e3e3b]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-display font-semibold text-zinc-800 dark:text-zinc-100">{cliente.nome}</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-zinc-50 dark:bg-zinc-900 p-3 rounded-xl border border-zinc-100 dark:border-zinc-800 flex items-center gap-3">
                    <Calendar className="w-5 h-5 text-[#84A59D]" />
                    <div>
                ...
                <div className="space-y-1.5 pt-2 border-t border-zinc-100 dark:border-zinc-800">
                  ...
                  <div className="bg-zinc-55 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 p-3 rounded-xl text-xs text-zinc-650 dark:text-zinc-400 italic leading-relaxed min-h-[96px] whitespace-pre-wrap">
                      ...
                      return (
                        <div key={idx} className="bg-[#F8FBFB] dark:bg-[#1a2322] border border-[#E8EFEF] dark:border-[#2e3e3b] p-3 rounded-xl flex flex-col gap-2 shadow-xs">
                          <div className="flex items-center justify-between">
                            <span className="font-medium text-sm text-zinc-800 dark:text-zinc-200">{item.nome || "Serviço"}</span>
                            <span className="text-sm font-semibold text-[#3A4F4A]">{fmtBRL(item.valor || item.preco_unitario)}</span>
                          </div>
